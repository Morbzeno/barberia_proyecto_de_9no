...
class CartController extends Controller
{
    ...
    public function createPaypalOrder(Request $request){
        ...
        // Forzamos el uso de la IP local para que el celular pueda regresar aquí
    ...
    public function paypalReturn(Request $request){
        ...
        <body style='background-color: #f3f4f6; font-family: system-ui, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0;'>
            <div style='background: white; padding: 40px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); text-align: center; max-width: 400px;'>
                ...
                <h1 style='color: #1f2937; margin: 0 0 10px 0;'>¡Pago Completado!</h1>
                <p style='color: #6b7280; margin-bottom: 30px;'>Tu pedido ha sido procesado con éxito. Ya puedes regresar a la aplicación.</p>
                <a href='http://192.168.100.11:8000/products' style='background-color: #4f46e5; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: bold;'>Volver a la Tienda</a>
            </div>
        </body>";
    }
